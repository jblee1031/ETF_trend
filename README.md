...
- `.github/workflows/update.yml` — 국내 ETF용, 평일 15:40 KST 자동 실행
- `.github/workflows/update_us.yml` — 미국용, 평일 06:30 KST 자동 실행
- `.github/workflows/update_krx_alignment.yml` — 코스피200 + 코스닥150, 매일 21:00 KST 자동 실행
...
- **코스피200 / 코스닥150 정배열**: **매일 21:00 KST** (퇴근 후 확인용). 두 시장을 한 워크플로우에서 순서대로 돌려 커밋을 하나로 만듭니다 — 같은 시각에 두 워크플로우가 같은 브랜치로 push하면 충돌하기 때문입니다.
